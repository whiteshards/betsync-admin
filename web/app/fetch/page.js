...
export default function FetchPage() {
  ...
  return (
    <div className="min-h-screen bg-[#111111] text-white font-sans"> {/* Added font-inter class */}
      ...
      <div className="pt-20 px-6 pb-6 max-w-7xl mx-auto">
        ...
        <div className="bg-[#1a1a1a] rounded-xl p-6 shadow-md border border-[#2a2a2a] mb-6">
          <div className="flex flex-col md:flex-row gap-4">
            <input
              ...
              className="flex-1 bg-[#2a2a2a] border border-[#333333] rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-purple-500 text-white font-sans"
            />
            <button
          ...
          {error && (
            <div className="mt-4 bg-red-900/20 border border-red-800 text-red-400 px-4 py-3 rounded-lg font-sans">
              {error}
            </div>
          )}
        </div>
        ...
        {serverData && (
          <div className="bg-[#1a1a1a] rounded-xl p-6 shadow-md border border-[#2a2a2a]">
            <h2 className="text-xl font-semibold mb-4 font-sans"> {/* Added font-inter class */} {serverData.serverName}</h2>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div className="bg-[#222222] rounded-lg p-4 border border-[#2a2a2a] font-sans"> {/* Added font-inter class */}
              ...
              <div className="space-y-4">
                <div className="bg-[#222222] rounded-lg p-4 border border-[#2a2a2a] font-sans"> {/* Added font-inter class */}
                  ...
                  {Object.entries(serverData.cryptoValues).map(([crypto, data]) => (
                    <div key={crypto} className="flex justify-between items-center mb-2 font-sans"> {/* Added font-inter class */}
